...
exports.userGetDetails = (req, res, next) => {
...
/**
 * @title User Details Route (Email)
 *
 * @desc Used to retrieve users details using email
...
exports.userSearchEmail = (req, res, next) => {
    const email = req.params.email;

    const statement = 'SELECT userid, email, username' + 
                    ' FROM public.alluser WHERE email = $1;';
    const values = [email];
